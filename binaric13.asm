...
Convertir1:
    ...
    mostrar_binario:
        mov dx, 0
        mov al, resultado[si] ; Tomar el siguiente dígito binario de la cadena
        add al, '0'   ; Convertir el bit a carácter ASCII
        mov dl, al
        int 21h
        inc si      ; Avanzar en la cadena
        cmp si, 8 ; Comprobar si se llegó al final de la cadena
        jl mostrar_binario
