...
conversion_loop:
    ...
    ; Mostrar el resultado binario en orden inverso
    mov si, offset resultado + 8 ; Puntero al final de la cadena
mostrar_loop:
    mov ah, 02h
    mov dl, [si] ; Tomar el siguiente dígito binario de la cadena
    int 21h
    dec si      ; Retroceder en la cadena
    cmp si, offset resultado - 1 ; Comprobar si se llegó al inicio de la cadena
    jae mostrar_loop
