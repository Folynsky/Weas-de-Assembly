...
mulrus proc far
    ...
    mov ax, dato1        ; Carga el multiplicando
    mov bx, dato2        ; Carga el multiplicador
...
multiplica:
    ...
    mov dato1, ax
    call imprimeres
    add cx, ax           ; Sumar el multiplicando al acumulador, ignorar el flag de acarreo aquí
...
siguiente:
    ...
    mov dato1, ax
    call imprimeres
    shl ax, 1            ; Duplicar el multiplicando, ignorar el flag de acarreo aquí
    ...
    ; Verificar si el resultado en CX excede 65534
    posicion 16,0
    imprimePasos pasomr4
    mov dato1, cx
    call imprimeres
    imprimeC mayorsim
    mov dato1, 65534
    ...
    imprimeC quest
    cmp cx, 65534
    ja overflow          ; Solo verificar el desbordamiento al final del proceso
...
overflow:
    ...
    ; Puedes agregar una lógica aquí para reiniciar la multiplicación si es necesario
...
;overflow_message db 'Error: Desbordamiento en la multiplicacion.', 0Dh, 0Ah, '$'
